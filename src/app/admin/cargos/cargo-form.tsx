...
import { createCargo } from "@/lib/actions/cargos";
import { MarcosCheckboxes } from "./marcos-checkboxes";

export function CargoForm() {
  const [state, action, pending] = useActionState(createCargo, undefined);

  return (
    <form
      action={action}
      className="flex flex-col gap-4 rounded-lg border border-primary-border p-4"
    >
